...
public class RegExpressionExample3 {
	...
	public static void main(String[] args) {
		...
		System.out.println(msg2.matches("hello ([a-z]*)")); //false
		System.out.println(msg2.matches("hello ([a-z0-9]*)")); //false
		System.out.println(msg2.matches("hello ([a-z0-9가-힣]*)")); //true 
		System.out.println(msg2.matches("hello\\p{Space}([a-z0-9가-힣]*)")); //true
		
		System.out.println("------------------------");
		String msg3 = "gooooooogle";
		System.out.println(msg3.matches("google")); // false
		System.out.println(msg3.matches("go*gle")); //true
