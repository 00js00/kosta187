...
import commom.YongProtocol;
import gui.YongMainFrame;
...
//				mainFrame.getWaitingPanel().roomList.add(tokens[2]);
			...
			case YongProtocol.SECRET_CHAT:
				...
				mainFrame.appendMessage("["+tokens[1]+">>"+tokens[2]+"]: " + secretMessage + String.format("%10s", " ")+ curTime);
				break;
			...
			case YongProtocol.SELECT_ROOM:
				...
				break;
			case YongProtocol.FULL_MEMBER:
				JOptionPane.showMessageDialog(mainFrame, "최대인원을 초과하였습니다.");
