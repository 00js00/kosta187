...
public class TalkFrame extends Frame implements WindowListener{
	...
	GridBagLayoutPanel2 gridBagLayoutPanel2;
	...
	public TalkFrame(String title) {
		...
		mainPanel = new MainPanel(this); //양방향일때는 서로 참조할 수 있도록 변수 이름을 가지고 있어야함
		
		gridBagLayoutPanel2 = new GridBagLayoutPanel2(this)	;
	...
	public void setContents() {
		...
		cardPanel.add("SEND",gridBagLayoutPanel2);
