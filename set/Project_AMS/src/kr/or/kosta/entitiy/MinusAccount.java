...
public class MinusAccount extends Account {
	...
	public String toString() {
		return String.format("%-13s%-25s%-15s%,-15d%,-15d" , "마이너스계좌" ,getAccountNum(),getAccountOwner(),super.getRestMoney() - getBorrowMoney(),getBorrowMoney());
	}
}
