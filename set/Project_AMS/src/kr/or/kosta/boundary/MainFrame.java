...
public class MainFrame extends Frame {
	...
	public void init() {
		...
		this.add(panel);
		try {
			manager.add(new Account("1111-2222-3333", "서지원", 1111, 200000));
			manager.add(new Account("5555-2222-3333", "최지원", 1111, 1000000));
			manager.add(new Account("6666-2222-3333", "최지원", 1111, 2000000));
			manager.add(new Account("2222-2222-3333", "김지원", 1111, 200000));
			manager.add(new Account("3333-2222-3333", "이지원", 1111, 300000));
			manager.add(new Account("4444-2222-3333", "박지원", 1111, 400000));

			MinusAccount minusAccount = new MinusAccount();
			MinusAccount minusAccount2 = new MinusAccount("9999-1111-2222", "김대출", 1111, 200, 1000000);
	...
	public void Line() {
		...
		panel.accountListTA.append("----------------------------------------------------------------------------------" + "\n");
		panel.accountListTA.append(String.format("%-13s%-25s%-15s%-15s%-15s\n" , "계좌종류" ,"계좌번호","예금주명","현재잔액","대출금액"));
		panel.accountListTA.append("==================================================================================" + "\n");
	}
	...
	public void eventRegist() {
		...
		panel.choiceC.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				} else panel.loanTF.setEnabled(false);
