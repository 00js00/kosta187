...
public class ProgressBarFrame extends JFrame{
	...
	JProgressBar progressBar; // 프로그램 어떻게 진행되는지~  
	JPanel buttonPanel;
	...
	public ProgressBarFrame(String fileName) {
		...
		progressBar = new JProgressBar(0, 100); // 백분율
		progressBar.setPreferredSize(new Dimension(350, 20)); // 바 크기
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new Thread() { // 서버에서 독립적으로 받는 거기 때문에 thread
			public void run() {
